...
from espnet2.enh.separator.tisdiss_separator import TISDiSS_Separator
        ...
        if use_preprocessor:
            ...
            if args.preprocessor == "dynamic_mixing":
                retval = preprocessor_choices.get_class(args.preprocessor)(
                    ...
                    fix_speech_length=args.preprocessor_conf.get(
                        "fix_speech_length", None
                    ),
                )
