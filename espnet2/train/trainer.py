...
class TrainerOptions:
    ...
    check_early_stopping_begin_epoch: int
        ...
        for iepoch in range(start_epoch, trainer_options.max_epoch + 1):
            ...
            if trainer_options.patience is not None:
                if reporter.check_early_stopping(
                    trainer_options.patience, *trainer_options.early_stopping_criterion, check_early_stopping_begin_epoch=trainer_options.check_early_stopping_begin_epoch
                ):
                    break
